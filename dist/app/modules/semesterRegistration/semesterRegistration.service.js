...
const updateSemesterRegistrationsFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (currentSemesterStatus === semesterReegistration_constant_1.RegistrationStatus.ENDED) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, `This semester is already ${currentSemesterStatus}`);
    }
    // UPCOMING --> ONGOING --> ENDED
    if (currentSemesterStatus === semesterReegistration_constant_1.RegistrationStatus.UPCOMING &&
    ...
    if (currentSemesterStatus === semesterReegistration_constant_1.RegistrationStatus.ONGOING &&
